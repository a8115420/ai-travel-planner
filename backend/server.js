// server.js (最終、絕對完整、順序正確的版本)

// --- 步驟一：引入所有需要的工具箱 (Dependencies) ---
...
app.use(session({
    ...
    cookie: { secure: false } // 在本地開發設為 false，未來可依據環境變數調整
}));
...
// Itineraries 路由 (從 routes/itineraries.js 合併進來)
...
// Google 路由 (從 routes/google.js 合併進來)
